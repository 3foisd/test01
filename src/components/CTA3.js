...
function CTA3() {
    return (
        ...
        <div className='bg-gray-200 rounded-xl gap-10 lg:gap-0 pl-10 py-10 flex flex-col lg:flex-row justify-between'>
            <div className='w-full lg:w-4/12'>
                <h2 className='text-5xl'>Let us take care of your health</h2>
