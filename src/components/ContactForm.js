            ...
            <section class="bg-gray-200 rounded-xl w-full lg:w-2/3">
                <div class="py-8 lg:py-16 px-4 mx-auto max-w-screen-md">
                    <form action="#" className="flex flex-wrap items-center space-y-8">
                        ...
                        <button type="submit" class="py-3 px-5 text-sm font-medium text-center text-white rounded-lg bg-indigo-950 sm:w-fit hover:bg-primary-800 focus:ring-4 focus:outline-none focus:ring-primary-300 dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">Send message</button>
                    </form>
                </div>
            </section>
        </div>
