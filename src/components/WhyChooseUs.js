    ...
    return (
        ...
        <div>
            <div className='py-5'>
                ...
                <h2 className='text-4xl w-full lg:w-4/12'>The right care for your loved ones</h2>
            </div>
            ...
            <div className='flex flex-col lg:flex-row gap-10 lg:gap-5'>
                <Link href="/">
                    <div className="bg-gray-200 rounded-xl pt-10">
                        ...
                        <Image className='rounded-b-xl' src="/images/freepik__candid-image-photography-natural-textures-highly-r__43460.jpg" width="400" height="400" />
                    </div>
                </Link>
