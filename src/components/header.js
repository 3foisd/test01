    ...
    <nav class="bg-white border-gray-200 px-4 lg:px-6 py-2.5 dark:bg-gray-800">
        <div class="flex flex-col lg:flex-row justify-between items-center mx-auto max-w-screen-xl">
            ...
            <div class="hidden justify-between items-center w-full lg:flex lg:w-auto lg:order-1" id="mobile-menu-2">
                <ul class="flex flex-col gap-2 items-center font-medium lg:flex-row lg:space-x-8">
                    <li>
                    ...
                    <button className="flex flex-row lg:hidden justify-around items-center mt-5 bg-indigo-950 hover:bg-red-950 w-64 h-12 rounded-full text-white">
            ...
            <div class="flex gap-4 items-center">
                <button className="flex flex-row hidden lg:flex justify-around items-center bg-indigo-950 hover:bg-red-950 w-64 h-12 rounded-full text-white">
                  <Image src="/webfonts/bell-regular white.svg" width="24" height="24" alt="map"/>
                  <Link href="">Schedule an appointment</Link>
                </button>
                ...
                <button data-collapse-toggle="mobile-menu-2" type="button" class="inline-flex items-center p-2 ml-1 mt-3 text-sm text-gray-500 rounded-lg lg:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600" aria-controls="mobile-menu-2" aria-expanded="false">
