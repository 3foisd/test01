...
function newsletter() {
    return (
      <div className='bg-indigo-950 rounded-[25px] mx-auto mb-32 flex flex-col lg:flex-row w-full lg:h-96'>
        <div className='w-full lg:w-6/12 text-white mb-10 lg:mb-0 px-5 lg:px-0 lg:pl-5 flex flex-col justify-center align-items-center'>
