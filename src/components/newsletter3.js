...
function newsletter3() {
    return (
        ...
        <div className='bg-hero-pattern bg-cover flex flex-col lg:flex-row justify-center items-center w-full text-white px-5 lg:px-0 pb-10 lg:pb-0 lg:pl-5 rounded-xl mx-auto w-full lg:h-96'>
            ...
            <div className='flex flex-row mx-auto mt-5 justify-around items-center bg-white w-full lg:w-80 h-12 rounded-full pr-2'>
                <input type="email" id="email" class="border-0 rounded-full w-full h-12 text-black text-center lg:text-start" placeholder="Enter your email" required></input>
