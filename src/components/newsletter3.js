...
function newsletter3() {
    return (
        ...
        <div className='flex flex-col lg:flex-row justify-center items-center w-full text-white px-5 lg:px-0 pb-10 lg:pb-0 lg:pl-5 bg-indigo-950 rounded-xl mx-auto w-full lg:h-96'>
