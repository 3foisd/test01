        ...
        <div className="flex flex-col gap-5">
            <div className="flex flex-col lg:flex-row justify-between">
                ...
                <div className="flex flex-row gap-2">
                    <div className="bg-blu-200 hover:bg-indigo-950 rounded-full w-16 h-16">
                        <Link href="/">
            ...
            <div className="flex flex-col lg:flex-row gap-4">
                <div className="bg-blu-200 hover:bg-red-950 hover:text-white rounded-xl py-5 px-5 w-full lg:w-1/3 flex flex-col justify-center">
