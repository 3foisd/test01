    ...
    return (
        <div>
            ...
            <div className="flex flex-col gap-4 lg:flex-row mt-10">
                <div className="bg-gray-200 rounded-xl flex flex-col justify-center px-5 w-full lg:w-1/3 py-10 lg:py-0">
                    <Link href="/">
                        <Image className="pb-5" src="/webfonts/circle-check-regular.svg" width="75" height="75" alt="circle-check"/>
                    </Link>
                    <Link href="/">
                ...
                <div className="bg-red-950 rounded-xl text-white py-10 px-5 w-full lg:w-1/3">
