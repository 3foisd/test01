        ...
        <div className="bg-gray-200 rounded-xl">
            ...
            <div className='flex flex-col lg:flex-row justify-between items-center px-10 pt-10 lg:pt-20 pb-16'>
                <div className="w-full lg:w-5/12 mb-5 lg:mb-0">
                    <h2 className="text-3xl lg:text-4xl mb-2">The story of how novamed was founded</h2>
            ...
            <div className='flex flex-col lg:flex-row items-center justify-around pb-10 gap-5 lg:gap-0'>
                <div className='bg-indigo-950 hover:bg-red-950 text-white rounded-full w-44 flex flex-col items-center py-1.5'>
